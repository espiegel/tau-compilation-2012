...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Dec 07 19:26:45 IST 2012
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\031\000\002\003\003\000\002\002\004\000\002\003" +
    "\003\000\002\002\003\000\002\004\007\000\002\005\003" +
    "\000\002\005\003\000\002\005\004\000\002\005\004\000" +
    "\002\006\005\000\002\006\005\000\002\011\004\000\002" +
    "\011\005\000\002\007\012\000\002\007\013\000\002\014" +
    "\003\000\002\014\005\000\002\013\004\000\002\010\003" +
    "\000\002\010\003\000\002\012\003\000\002\012\003\000" +
    "\002\012\003\000\002\012\005\000\002\012\003" });
      ...
      switch (CUP$Parser$act_num)
		...
		Object t = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new PrimitiveType(((Token)t).getLine(), DataTypes.VOID); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("methodtype",6, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Formal(t, n); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 16: // formals_list ::= formals_list COMMA formals 
            {
		...
		Formal m = (Formal)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 l.add(m); RESULT = l; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("formals_list",10, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 15: // formals_list ::= formals 
            {
              List<Formal> RESULT =null;
		...
		Formal l = (Formal)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 List<Formal> lf = new ArrayList<Formal>(); lf.add(l); RESULT=lf;  
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("formals_list",10, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // method ::= STATIC methodtype ID LP formals_list RP LCBR stmt_list RCBR 
            {
              Method RESULT =null;
		...
		List<Statement> s = (List<Statement>)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = new StaticMethod(t, n, f, s); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // method ::= methodtype ID LP formals_list RP LCBR stmt_list RCBR 
            {
              Method RESULT =null;
		int tleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-7)).left;
		int tright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-7)).right;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 m.add(n); RESULT = m; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("morefields",7, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 List<String> l = new ArrayList<String>(); l.add(n); RESULT=l; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("morefields",7, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
