...
public class SemanticChecker implements Visitor
{
	...
	public Object visit(Program program) {
		...
		if(!this.GST.hasMain())
			try {
				throw new SemanticError("Program does not have a main method",GST.getStringId(),-1);
	...
	public Object visit(VariableLocation location) {
        ...
        { 
            try
            {
                ...
                location.resolveExprType(thisLocationType);
	...
	public Object visit(This thisExpression) {
	    ...
	    thisExpression.resolveExprType(type);
	    return type;
	}
	...
	public Object visit(MathBinaryOp binaryOp) {
       ...
       // Check everything instead of "+" : "-","*","/","%"
        ...
        binaryOp.resolveExprType(op1Type);
	...
	public Object visit(MathUnaryOp unaryOp) {
        ...
        unaryOp.resolveExprType(opType);
        return opType; 
	}
